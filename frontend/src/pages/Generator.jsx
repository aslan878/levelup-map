...
export default function Generator({
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden flex pt-16">
      ...
      {/* Zoom Controls */}
      {data && (
        <div className="export-hide absolute top-48 right-6 z-20 flex flex-col gap-2">
          {/* Progress indicator */}
      ...
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-96' : 'w-0'} transition-all duration-300 bg-slate-900/95 backdrop-blur-xl border-l border-slate-700/50 z-10 overflow-hidden`}>
        {/* Close/Open Button */}
        <button
